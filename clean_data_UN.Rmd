...
setnames(data, old = c("Q15c","Q19a","Q19b","Q19c","Q19d","Q19e","Q20a","Q20b","Q20c","Q20d","Q20e","Q20f","Q20g","Q13b_a","Q13b_c","Q15b","Q13k_a","Q13k_c"), new = c("stoppeded","specpre","specprim","specsec","spectert","specvoc","refpre","refprim","refsec","refspecsch","refspeccls","refuni","reftert","neededas","receivedas","stoppedas","neededleg","receivedleg"))

stoppededflag <- rep("NA", nrow(data))
specpreflag <- rep("NA", nrow(data))
specprimflag <- rep("NA", nrow(data))
...
data <- cbind(data, stoppededflag, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, neededasflag, receivedasflag, stoppedasflag, neededlegflag, receivedlegflag)
```
...
data <- cbind(data, foodflag, novoteflag, stoppededflag, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, refuniflag, neededasflag, receivedasflag, stoppedasflag, neededlegflag, receivedlegflag, newsflag)
```
...
data <- merge(data[,c("head","ind","hid")],data1[,c("head","ind","hid","genvio","famvio","institutionalized","toilet","rec","neededw","receivedw","q15c1","q18a","q18b","q18c","q18d","q18e","q19a","q19b","q19c","q19d","q19e","q19f","q13b1","q13b3","q15b1","q13k1","q13k3")], all.x = TRUE) %>%
  .[,4:27] %>%
  cbind(data, .)
...
setnames(data, old = c("q15c1","q18a","q18b","q18c","q18d","q18e","q19a","q19b","q19c","q19d","q19e","q19f","q13b1","q13b3","q15b1","q13k1","q13k3"), new = c("stoppeded","specpre","specprim","specsec","spectert","specvoc","refpre","refprim","refsec","refspecsch","refspeccls","refuni","neededas","receivedas","stoppedas","neededleg","receivedleg"))
...
data <- cbind(data, stoppededflag, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, refuniflag, neededasflag, receivedasflag, stoppedasflag, neededlegflag, receivedlegflag)
```
...
setnames(data, old = c("F3_1_C_5","E4_5_A","E4_5_B","E4_5_C","E4_5_D","E4_5_E","E4_6_A","E4_6_B","E4_6_C","E4_6_D","E4_6_E","F3_1_B_2","F3_1_B_3","F3_1_B_5"), new = c("stoppeded","specpre","specprim","specsec","spectert","specvoc","refpre","refprim","refsec","refspecsch","refspeccls","neededas","receivedas","stoppedas"))
...
data <- cbind(data, stoppededflag, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, neededasflag, receivedasflag, stoppedasflag)
```
...
setnames(data, old = c("q4.5a","q4.5b","q4.5c","q4.5d","q4.5e","q4.6a","q4.6b","q4.6c","q4.6d","q4.6e","q3.1b.2","q3.1b.3","q3.2b"), new = c("specpre","specprim","specsec","spectert","specvoc","refpre","refprim","refsec","refspecsch","refspeccls","neededas","receivedas","stoppedas"))
...
data <- cbind(data, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, neededasflag, receivedasflag, stoppedasflag)
```
...
setnames(data, old = c("q4.5a","q4.5b","q4.5c","q4.5d","q4.5e","q4.6a","q4.6b","q4.6c","q4.6d","q4.6e","q3.1b.2","q3.1b.3"), new = c("specpre","specprim","specsec","spectert","specvoc","refpre","refprim","refsec","refspecsch","refspeccls","neededas","receivedas"))
...
data <- cbind(data, specpreflag, specprimflag, specsecflag, spectertflag, specvocflag, refpreflag, refprimflag, refsecflag, refspecschflag, refspecclsflag, neededasflag, receivedasflag)
```
